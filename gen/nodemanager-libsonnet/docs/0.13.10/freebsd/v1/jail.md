---
permalink: /0.13.10/freebsd/v1/jail/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withInet6s(inet6s)`](#fn-specwithinet6s)
  * [`fn withInet6sMixin(inet6s)`](#fn-specwithinet6smixin)
  * [`fn withInets(inets)`](#fn-specwithinets)
  * [`fn withInetsMixin(inets)`](#fn-specwithinetsmixin)
...
### fn spec.withInet6sMixin

```ts
withInet6sMixin(inet6s)
```
...
### fn spec.withInetsMixin

```ts
withInetsMixin(inets)
```
