---
permalink: /0.10.11/freebsd/v1/jailTemplate/
---

# freebsd.v1.jailTemplate
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withPostCreate(postCreate)`](#fn-specwithpostcreate)
  * [`fn withPostCreateMixin(postCreate)`](#fn-specwithpostcreatemixin)
  ...
  * [`obj spec.postCreate`](#obj-specpostcreate)
    * [`fn withArgs(args)`](#fn-specpostcreatewithargs)
    * [`fn withArgsMixin(args)`](#fn-specpostcreatewithargsmixin)
    * [`fn withCommand(command)`](#fn-specpostcreatewithcommand)
    * [`fn withName(name)`](#fn-specpostcreatewithname)
...
new returns an instance of JailTemplate
...
### fn spec.withPostCreateMixin

```ts
withPostCreateMixin(postCreate)
```
...
### fn spec.postCreate.withArgsMixin
...
### fn spec.postCreate.withCommand
