---
permalink: /0.4.11/iot/v1/device/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withIeee_address(ieee_address)`](#fn-specwithieee_address)
  ...
  * [`fn withNetwork_address(network_address)`](#fn-specwithnetwork_address)
...
### fn spec.withIeee_address

```ts
withIeee_address(ieee_address)
```

"IEEEAddress is the stable 64-bit IEEE MAC address of the device (hex, e.g. \"0x00124b0037e6f451\"). This is permanent and survives network address reassignment."
...
### fn spec.withNetwork_address

```ts
withNetwork_address(network_address)
```

"NetworkAddress is the current 16-bit Zigbee network address of the device (hex, e.g. \"0x1234\"). This may change when the device rejoins the network."
