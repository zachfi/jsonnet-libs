---
permalink: /0.4.0/iot/v1/binding/
---
...
"Value is the expected value rendered as a string. For booleans use \"true\" / \"false\". For action enums use the action name (e.g. \"single\", \"double\", \"on\"). May be empty to match any value of the property."
