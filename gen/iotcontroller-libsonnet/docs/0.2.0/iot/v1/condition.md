---
permalink: /0.2.0/iot/v1/condition/
---
...
"TimeIntervals define the windows during which this remediation is applicable.  If the conditioner receives an event outside of this range, the zone will be set to the inactive state, if defined in the condition spec."
...
"WhenGate is used to create a window for the epoch around which this Remediation is applicable.  When is relative to the \"when\" label. i.e. If the epoch in the label is at 10am, and the when.start is -30, then the event will fire 30 minutes before, at 9:30am."
