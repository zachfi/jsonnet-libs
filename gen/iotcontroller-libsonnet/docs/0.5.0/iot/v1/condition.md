---
permalink: /0.5.0/iot/v1/condition/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.remediations`](#obj-specremediations)
    * [`fn withActive_brightness_delta(active_brightness_delta)`](#fn-specremediationswithactive_brightness_delta)
    * [`fn withActive_compute(active_compute)`](#fn-specremediationswithactive_compute)
    * [`fn withActive_compute_args(active_compute_args)`](#fn-specremediationswithactive_compute_args)
    * [`fn withActive_compute_argsMixin(active_compute_args)`](#fn-specremediationswithactive_compute_argsmixin)
    ...
    * [`obj spec.remediations.time_intervals`](#obj-specremediationstime_intervals)
      ...
      * [`fn withSun_relative(sun_relative)`](#fn-specremediationstime_intervalswithsun_relative)
      * [`fn withSun_relativeMixin(sun_relative)`](#fn-specremediationstime_intervalswithsun_relativemixin)
      ...
      * [`obj spec.remediations.time_intervals.sun_relative`](#obj-specremediationstime_intervalssun_relative)
        * [`fn withAfter(after)`](#fn-specremediationstime_intervalssun_relativewithafter)
        * [`fn withBefore(before)`](#fn-specremediationstime_intervalssun_relativewithbefore)
        * [`fn withEvent(event)`](#fn-specremediationstime_intervalssun_relativewithevent)
